...
urlpatterns = [
    ...
    path('shortlists/<int:id>/remove_all/', views.remove_all_from_shortlist, name='remove_all_from_shortlist'),
    path('shortlists/<int:id>/add_all/', views.add_all_to_shortlist, name='add_all_to_shortlist'),
