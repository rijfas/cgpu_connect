...
urlpatterns = [
    ...
    path('shortlists/<int:id>/add/', views.add_to_shortlist, name='add_to_shortlist'),
    path('shortlists/<int:id>/remove/', views.remove_from_shortlist, name='remove_from_shortlist'),
