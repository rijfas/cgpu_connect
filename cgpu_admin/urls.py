...
urlpatterns = [
    ...
    path('accounts/<int:id>/activate/', views.activate_account, name='activate_account'),
    path('accounts/<int:id>/deactivate/', views.deactivate_account, name='deactivate_account'),
